<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Backend.Master" CodeFile="Users.aspx.cs" Inherits="Bai21.Users" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="table text-center">
        ...
        <button onclick="deleteUser(100); return false;">BTN</button>
        <br />
        <br />
        <table id="myTable" class="table" style="margin:auto ; width: 75%; ">
      
 
        </table>
       
    </div>
    <button onclick="get()">BTON</button>
     <p id="demo">Demo </p>
    <div id="div1"></div>
</asp:Content>
